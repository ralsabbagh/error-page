var loaderSvg = getElmntByClass('box-loader');
loaderSvg.setAttribute('style', 'transform: scale(1.1);');

var circle1 = getElmntByClass('path-loader');
...
var animateTransform1 = getElmntByClass('transform-loader');
...
var circle2 = getElmntByClass('path-loader-inner');
...
var animateTransform2 = getElmntByClass('transform-loader-inner');
